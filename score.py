...
class Score:
    ...
    def prep_score(self, p_points, c_points):
        ...
        colon_str = ':'
        self.colon = self.font.render(colon_str, True, self.text_color, self.settings.bg_color)
        self.colon_rect = self.colon.get_rect(center=(self.settings.screen_width / 2,
    ...
    def show_score(self):
        ...
        self.screen.blit(self.colon, self.colon_rect)
